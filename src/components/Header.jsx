        ...
        {showMobile ? (
          <div className="mobile-menu">
            <div className="container">
              ...
              <p className="side-title mb-3">Каталог товаров</p>
              {categories &&
                categories.length &&
                categories.map((cat, i) => (
                  <p
                    className={
                      cat === active
                        ? "mb-1 category-active category-name"
                        : "mb-1 category-name"
                    }
                    key={i}
                    onClick={(e) => {
                ...
                {cart && cart.items && cart.items.length ? (
                  <div className="d-flex justify-content-between mb-3">
                    <span className="fw-bold">
                      Итого: {Number(cart.totalAmount).toFixed(2)} руб.
                    </span>
                    <span
                      className="prime-text-link"
